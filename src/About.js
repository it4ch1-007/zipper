...
export default function About(){
    ...
    />
        ...
        However, I am exploring cybersecurity since my first year of college in the domain of reverse engineering <br></br> and other low-level stuff like malwares that made me fall in love with Rust and CPP<br></br>
        I love writing Rust and C/C++ and also reverse engineering the softwares written in them when required.<br></br>
        <br></br>
        </Text>
        <h3>About the project</h3>
        <Text>
        Among my projects, Zipper stands out as a significant achievement, developed entirely using Rust.<br></br>
        It utilises Tauri, a Rust framework just like electronJS that helps to build desktop web applications.<br></br>
        ...
        Also it has a try-catch based password prompt functionality that reduces user's time and increases efficiency.<br></br>
